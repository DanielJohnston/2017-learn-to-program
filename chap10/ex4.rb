# Wedding Number: Expanded English, with random 'and' insertion
...
def english_number original_number
  ...
  english_result = exploded_number.reduce(["",:start]) { |text_string, base_pair|
    ...
    if base_pair.class == Integer
      ...
      text_string[0] += 'and ' if rand(2) == 1 && text_string[1] != :start
...
# Main code
puts 'Enter a number to convert. Negative number to quit'
number = gets.to_i
